...
"use client"; // If using client-side interactivity like the CopyButton
    ...
    return (
      <div className="max-w-[70vw] mx-auto p-4">
        ...
        <div className="mt-6 flex flex-wrap gap-4">
          ...
          <div className="flex items-center bg-gray-100 dark:bg-[#27272a] shadow px-4 py-2 rounded flex-1">
